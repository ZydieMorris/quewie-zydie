...
<template>
  <main class="relative px-4 md:px-12 lg:px-24 py-16">
    ...
    <p class="font-normal text-lg md:text-2xl lg:text-[36px] leading-relaxed text-center text-[#696984] mt-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-16 justify-items-center">
      ...
      <div class="pt-10 h-auto w-full max-w-[544px] rounded-[20px] shadow-[0px_8px_7.3px_1px_#00000008] bg-[#F6F6F6]">
        ...
        <div class="px-4 mt-6 text-center space-y-5">
          <h1 class="text-2xl md:text-[32px] font-semibold text-[#272727]">
            Customer <span class="text-[#388FF0]">Support</span>
          </h1>
          <p class="text-lg md:text-[25px] text-[#696984] leading-[180%] tracking-[2%]">
            Need help? Our dedicated support<br />team is just an email away.
          </p>
        </div>
      </div>
      ...
      <div class="pt-10 h-auto w-full max-w-[544px] rounded-[20px] shadow-[0px_8px_7.3px_1px_#00000008] bg-[#F6F6F6]">
        ...
        <div class="px-4 mt-6 text-center space-y-5">
          <h1 class="text-2xl md:text-[32px] font-semibold text-[#272727]">
            24/7 <span class="text-[#388FF0]">Live Assistance</span>
          </h1>
          <p class="text-lg md:text-[25px] text-[#696984] leading-[180%]">
            Get real-time help through live<br />chat or phone support.
          </p>
        </div>
      </div>
      ...
      <div class="pt-10 h-auto w-full max-w-[544px] rounded-[20px] shadow-[0px_8px_7.3px_1px_#00000008] bg-[#F6F6F6]">
        ...
        <div class="px-4 mt-6 text-center space-y-5">
          <h1 class="text-2xl md:text-[32px] font-semibold text-[#272727]">
            Training & <span class="text-[#388FF0]">Onboarding</span>
          </h1>
          <p class="text-lg md:text-[25px] text-[#696984] leading-[180%]">
            We offer personalized training<br />sessions and onboarding support.
          </p>
        </div>
      </div>
      ...
      <div class="pt-10 h-auto w-full max-w-[544px] rounded-[20px] shadow-[0px_8px_7.3px_1px_#00000008] bg-[#F6F6F6]">
        ...
        <div class="px-4 mt-6 text-center space-y-5">
          <h1 class="text-2xl md:text-[32px] font-semibold text-[#272727]">
            System Maintenance & <span class="text-[#388FF0]">Updates</span>
          </h1>
          <p class="text-lg md:text-[25px] text-[#696984] leading-[180%]">
            Enjoy seamless, automatic<br />updates with the latest features.
          </p>
        </div>
      </div>
      ...
      <div class="pt-10 h-auto w-full max-w-[544px] rounded-[20px] shadow-[0px_8px_7.3px_1px_#00000008] bg-[#F6F6F6]">
        ...
        <div class="px-4 mt-6 text-center space-y-5">
          <h1 class="text-2xl md:text-[32px] font-semibold text-[#272727]">
            Community & <span class="text-[#388FF0]">Resources</span>
          </h1>
          <p class="text-lg md:text-[25px] text-[#696984] leading-[180%]">
            Enjoy seamless, automatic<br />updates with the latest features.
          </p>
    ...
    <div class="mt-20 text-center">
      <p class="text-xl md:text-2xl lg:text-[36px] leading-[180%] tracking-[2%] text-[#696984]">
        Still have questions? Contact our support team today.
      </p>
    </div>
