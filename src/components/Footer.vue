...
<template>
    <div class="w-full h-[308px] bg-[#2F2F2F]  ">
        <!-- Main Content -->
        <div class="ml-[130px] mr-[130px] ">
            ...
            <div class="flex justify-between mt-8 relative">
                ...
                <div class="absolute right-2 top-1.5 h-[46px] w-[46px] bg-[#388FF0] rounded-full">
                    <img src="/images/Vector.png" class="absolute top-3.5 left-5" />
                </div>
            </div>
            <!-- last -->
            <div class="flex justify-between text-white font-medium text-[18px] leading-[30px] mb-[48px]  mt-6">
                <p>© 2025 J7 IT Solutions. Copyright and rights reserved</p>
